...
# Kernel
BOARD_KERNEL_CMDLINE := selinux=0 audit=0 androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 sched_enable_hmp=1 sched_enable_power_aware=1 service_locator.enable=1 swiotlb=2048
...
TARGET_KERNEL_CONFIG := hybris_oneplus5_defconfig
